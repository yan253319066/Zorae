...
interface BrandShowcaseProps {
  ...
  onPitchIdea: (name: string) => void;
}

export default function BrandShowcase({ activeBrandTab, onTabChange, onPitchIdea }: BrandShowcaseProps) {
  return (
              ...
              <div key={mockup.id} className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
                <div className="lg:col-span-7 space-y-6">
                  ...
                  <div className="pt-4 flex flex-wrap gap-2.5">
                    <button
                      onClick={() => onPitchIdea(mockup.name)}
